...
- **`http` / `bridge` timeouts** — configure adapter defaults and per-call timeouts where supported (see [`docs/reference/ADAPTER_REGISTRY.md`](../reference/ADAPTER_REGISTRY.md) §2 for `http.Post` slot schema).
