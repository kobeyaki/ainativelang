...
- [`AINL_CORE_AND_MODULES.md`](AINL_CORE_AND_MODULES.md) — core language and module structure; **§8** documents repo **strict `include` libraries** ([`modules/common/`](../../modules/common/README.md), [`modules/llm/`](../../modules/llm/README.md)) and **app-local** trees (gateway-adjacent `modules/promoter/`, `prompts/`, etc.)
