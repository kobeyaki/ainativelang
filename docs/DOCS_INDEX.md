...
- Memory contract and v1 adapter: `docs/adapters/MEMORY_CONTRACT.md`
  ...
  - Opt-in **`last_accessed` / `access_count`** helpers (include module; graph-safe list path **`LACCESS_LIST_SAFE`**): `modules/common/access_aware_memory.ainl`, `modules/common/README.md`, `docs/RELEASE_NOTES.md` (v1.2.4)
