...
- `docs/IR_SCHEMA.md` — top‑level IR overview
- `docs/GRAPH_SCHEMA.md` — canonical graph/label/edge schema
...
For more structured queries, use the graph helpers described in `docs/GRAPH_SCHEMA.md`:
...
- **Safe edits:** helpers mentioned in `docs/GRAPH_SCHEMA.md`:
...
For runtime‑level introspection without live side‑effects, use the **record/replay** flags described in `docs/INSTALL.md`:
