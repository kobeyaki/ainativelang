...
const PACK_NAME = `StarfishKing_by_PlushifierBot`;
const PACK_TITLE = 'Starfish King 🌟';
const ANIMATED_DIR = path.join(__dirname, 'animated_v2');
...
async function main() {
  ...
  for (const s of STICKERS) {
    ...
    if (!res.ok) { console.error(`FAILED: ${JSON.stringify(res)}`); process.exit(1); }
    console.log('✓');
