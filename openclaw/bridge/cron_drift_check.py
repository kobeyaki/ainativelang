...
Official location: openclaw/bridge/ (OpenClaw integration layer).
...
Env:
  OPENCLAW_BIN — optional; else shutil.which("openclaw")
  AINL_REPO_ROOT — repo root (default: parent of openclaw/)
...
# openclaw/bridge/ -> openclaw/ -> repo root
