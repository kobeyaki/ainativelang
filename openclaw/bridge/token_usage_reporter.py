#!/usr/bin/env python3
"""Summarize token/budget signals for OpenClaw crons and ainl-advocate continuity."""
...
def _memory_dir() -> Path:
    o = os.getenv("OPENCLAW_MEMORY_DIR") or os.getenv("OPENCLAW_DAILY_MEMORY_DIR")
    if o:
