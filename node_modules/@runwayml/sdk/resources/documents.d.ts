...
export declare namespace DocumentCreateResponse {
    interface UsedBy {
        /**
         * The avatar ID.
         */
...
export declare namespace DocumentRetrieveResponse {
    interface UsedBy {
        /**
         * The avatar ID.
         */
