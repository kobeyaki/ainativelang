...
export declare namespace WorkflowRetrieveResponse {
    /**
     * The workflow graph definition.
     */
    interface Graph {
...
export interface WorkflowRunParams {
    ...
    nodeOutputs?: {
        [key: string]: {
            [key: string]: WorkflowRunParams.Primitive | WorkflowRunParams.Image | WorkflowRunParams.Video | WorkflowRunParams.Audio;
        };
    };
}
export declare namespace WorkflowRunParams {
    /**
...
export declare namespace Workflows {
    export { type WorkflowRetrieveResponse as WorkflowRetrieveResponse, type WorkflowListResponse as WorkflowListResponse, type WorkflowRunResponse as WorkflowRunResponse, type WorkflowRunParams as WorkflowRunParams, };
}
