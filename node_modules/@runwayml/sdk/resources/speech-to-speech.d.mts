 ...
 */
export declare class SpeechToSpeech extends APIResource {
    /**
     * This endpoint will start a new task to convert speech from one voice to another
     * in audio or video.
     */
    create(body: SpeechToSpeechCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<SpeechToSpeechCreateResponse>;
}
...
export declare namespace SpeechToSpeechCreateParams {
    /**
     * An audio file containing dialogue to be processed.
     */
    interface Audio {
...
export declare namespace SpeechToSpeech {
    export { type SpeechToSpeechCreateResponse as SpeechToSpeechCreateResponse, type SpeechToSpeechCreateParams as SpeechToSpeechCreateParams, };
}
//# sourceMappingURL=speech-to-speech.d.mts.map