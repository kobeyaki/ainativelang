...
class Avatars extends resource_1.APIResource {
    /**
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/v1/avatars/${id}`, options);
    }
    /**
    ...
    update(id, body = {}, options) {
        return this._client.patch((0, path_1.path) `/v1/avatars/${id}`, { body, ...options });
    }
    /**
     ...
     */
    list(query, options) {
        return this._client.getAPIList('/v1/avatars', (pagination_1.CursorPage), { query, ...options });
    }
    /**
     * Delete an avatar.
     *
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/v1/avatars/${id}`, {
            ...options,
