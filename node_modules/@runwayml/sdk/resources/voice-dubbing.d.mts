 ...
 */
export declare class VoiceDubbing extends APIResource {
    /**
     ...
     * ```
     */
    create(body: VoiceDubbingCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<VoiceDubbingCreateResponse>;
}
...
export declare namespace VoiceDubbing {
    export { type VoiceDubbingCreateResponse as VoiceDubbingCreateResponse, type VoiceDubbingCreateParams as VoiceDubbingCreateParams, };
}
//# sourceMappingURL=voice-dubbing.d.mts.map