...
export declare class AvatarVideos extends APIResource {
    /**
     ...
     * URL once complete.
     */
    create(body: AvatarVideoCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<AvatarVideoCreateResponse>;
}
...
export declare namespace AvatarVideoCreateParams {
    /**
...
export declare namespace AvatarVideos {
    export { type AvatarVideoCreateResponse as AvatarVideoCreateResponse, type AvatarVideoCreateParams as AvatarVideoCreateParams, };
}
//# sourceMappingURL=avatar-videos.d.ts.map